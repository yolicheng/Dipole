program curve_plf_pc
! Modified from the main_curve_plf.f90, used for an arbitraray torus, which is not 'polite' by Gerard's comment
! do a new version in main_curve_plf.f90
...
! Since at the moment, I am only able to handle 2D tori, one from the periodic orbit, one from its central part 
! and centre X centre will introduce one more frequency, which is beyond my capacity. 
