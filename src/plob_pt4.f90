!***********************************************************************    
!  this subroutine is to integrate 4 or 2 equilibrium points simultaneously, especially for the application of a formation flying configuration 
!  to make sure the sampling points are all isochronous with each other. 

!  and also compute the relative position and velocity, and check if the plane contains the 4 points doesn't change the direction
...
!  20160426 - dicard the fixed stepsize option, too slow and generate too many points
!    use  an row array that contains the n points that needed to be integrated.... 
!  
! Note: 
...
!  revised by Yu  -- 20160525
! --------------------------------------------------------------------------
subroutine plob_pt4(y0, np, t0,tf, tdir, fob, fdrv, fh, deriv_n, gr_cj) 
