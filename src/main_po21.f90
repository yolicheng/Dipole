program po21 !-- the second equilibrium -- test po
...
!  suffix 8:  vx = -1.d-5, vy = -1.d-5, vz = -
  ...
  write(fnpots,  fmt='(a,i0,a,i0,a,i0,a)') './dat/eq',ieq,'_bt', idint(beta), '_pots',ifam,'1.dat' 
  write(fnpopcts,  fmt='(a,i0,a,i0,a,i0,a)') './dat/eq',ieq,'_bt', idint(beta), '_popcts',ifam,'1.dat'   
! potential p.o.
  write(fnpopotts,  fmt='(a,i0,a,i0,a,i0,a)') './dat/eq',ieq,'_bt', idint(beta), '_popotts',ifam,'1.dat'   
