...
!***********************************************************************
subroutine PoincMap_prtbp( pvin, pvf, isdp, dp_dx)
...
!       we do not need to recomplie the module everytime we make some modification in this routine....      
...
!   subroutine poinc(sti, ndim, nvar, tdir, tf, stf, hminim, ispc, deriv, gr_cj) 
  ! subroutine poinc(sti, ndim, n, tf,stf, hminim, ispc,  deriv, gr_cj) 
