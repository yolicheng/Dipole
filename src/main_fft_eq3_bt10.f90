...
real(kind=dp) ::  wr(n),wi(n), vr(n,n), y0(neq), &   ! stability of equilibrium points
                  x0(6), vr_usd(6,3), dx0(6), epsl, epsl_dx(nob),  cj_tar, & !manifold of eq 
...
!************** Energy level: H3 = H0, interval 5.9 ~ 6
...
! cji = 3; cjf = 3
!epsl_dx = (/5.d-3, 2.d-2, 4.d-2, 6.0d-2, 5.99d-2, 5.992d-2, 5.994d-2,5.99601d-2, 5.998d-2, 5.999d-2/)
!obi = 1; obf = 10 

!!************** Energy level: H1 = H0-0.1, interva  5.1 ~ 5.2
...
! give up this energy level, because it is very close to H0, just a little bit smaller-20160201
!************** Energy level: H2 = H0-0.01, interval? 5.992~5.9932 a little smaller than H0
!epsl_dx = (/5.d-3, 2.d-2, 3.5d-2, 5.993d-2, 5.9931d-2, 5.9932d-2, 5.9924d-2, 5.9926d-2,5.9928d-2, 5.9929d-2/)!for test, look at the one around 6.2d-2, wrong
! cji = 2; cjf = 2
!obi = 4; obf = 6!9

!!************** Energy level: H2 = H0-0.01, interval? 5.992~6 a little smaller than H0(6 escape also)- almost identical with H_0, without detailed analysis.
!epsl_dx = (/5.d-3, 2.d-2, 4.d-2, 6.0d-2, 5.99d-2, 5.992d-2, 5.994d-2,5.99601d-2, 5.998d-2, 5.999d-2/)
! cji = 2; cjf = 2
!obi = 3; obf = 6!9
