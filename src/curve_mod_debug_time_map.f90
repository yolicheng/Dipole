...
external ::   gr_poinc, gr_cj, gr_dcj_dx !#, gr_cjlf 
...
!  print*, 'check dg_all, dg_xi:'
!  do k =  1, n, 1
!      write(fwork, '(12f18.8)') dg_all(k, :)
!  end do  
!  print*; read* 
...
!    subroutine PoincMap_plf( pvin, pvf, isdp, dp_dx)
 ...
 !---------------------------- debug ----------------------------
  ...
  ! ---- if rho is unknown, we have the last column as the differential w.r.t. rho 
  !   not used yet... 
  if(opt == 11) then 
