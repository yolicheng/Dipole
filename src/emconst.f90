...
! the dimension of the problem, 4: planar; 6: spatial 
!integer :: ndim 

real(kind=dp), parameter, private ::  pi = 4.d0*dtan(1.d0)
real(kind=dp), private ::  mu  ! declare as private, and use the common module massrat_rtbp_mod for a global mu
real(kind=dp) ::  rmoon, dsem, tuem,vuem , tmat(3,3), dtmat(3,3), &
                  mu_m, gmm  
...
!  implicit none 
  ...
  mu = 0.0123000369055232d0   ! use this one for the moment ...                           
