...
! For backup purpose,  2017-05-11 15:21:55  the file works fine.
...
! if a(i) / a_max  < 0.01, we put it to zero
a2m = 0
am_max = maxval(dabs(a))
do i = 1, nctr, 1
  if( dabs(a(i)) < 1.d-4 * am_max)  a(i) = 0.d0
  a2m = a2m + a(i)*a(i)
  print*, a(i), a2m
end do
a2m = dsqrt(a2m)
...
!print*, 'a2m = ', a2m; print*; read*
print*, 'check the submatrix a'
print*, a 

!print*; read* 

a = dble(dir) * a / dnrm2(nctr, a, 1)
