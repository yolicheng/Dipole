!***********************************************************************
!     ****   quad_extrem   ****   --- discard ---- 2017-03-02 11:11:33 

! but a better idea than bisection method is to use this routine to find a minimum(maximum) 
! of the period, and the use the fixed time shooting approach for the periodic orbit refinement.
 
!  Use quadratic polynomial to simulate 3 points, and find the minimum 
