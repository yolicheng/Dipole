subroutine eqprop_num( p0, np, tf, xmax, ramp, vamp, isob, fob, fds, fdsmax, deriv_n, iscap, dsmax, ymax)
...
!  fob          file tag of the propagation of all the points -- in principle, not used
...
integer, intent(in)     ::  np,  isob, fob, fds, fdsmax
