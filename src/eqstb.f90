program eqstb 
! Integrate the orbit with the initial state X0, until the point that at which the distance from the equilibrium points starts to decrease. 
! The state transition matrix up to this point could seen as pseudo-Monodromy matrix  to study the stability of the orbit, by checking the eigenvalues of this matrix 
...
! for sampling to do FFT, 2**12=4096, in general, it is enough  
nsm  = 2**14
