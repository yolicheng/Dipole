...
!
!********************************************************************
  SUBROUTINE GR_RK78(X,Y,N,H,HMIN0,HMAX0,E0,R,B,F)
  implicit none
...
!  external deriv
  ...
  DATA II/0/
  SAVE II,ALFA,BETARK,C,CP ! change beta to betack to avoid comflict with the beta in lf_mod... is it necessary? I don't think so
